	...
	public function admin_enqueue_scripts( $hook ) {
		switch ( $hook ) {
			...
			case 'toplevel_page_' . config::get( 'prefix' ) . 'options_page' :
				...
				wp_enqueue_script( config::get( 'prefix' ) . 'admin_scripts',
					config::get( 'plugin_url' ) . 'assets/js/plugins.min.js', array(
						'jquery',
						'jquery-ui-tabs',
						'jquery-ui-button',
						'jquery-ui-accordion',
		...
		wp_enqueue_style( 'jquery-ui-smoothness', config::get( 'plugin_url' ) . 'assets/css/plugins.min.css',
			config::get( 'version' ), config::get( 'version' ) );
	}
