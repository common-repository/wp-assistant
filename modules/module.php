...
class module {
	...
	public function get_modules() {
		return array(
			...
			'originalCss' => array(
				'name'       => __( 'Original CSS', 'wp-assistant' ),
				'desc'       => __( 'Setting for the site stylesheet.', 'wp-assistant' ),
				'default'    => 1,
				'activation' => 0,
			),
			'originalJs' => array(
				'name'       => __( 'Original JavaScript', 'wp-assistant' ),
				'desc'       => __( 'Setting for the site JavaScript.', 'wp-assistant' ),
				'default'    => 1,
				'activation' => 0,
			),
			...
			'templateEditor'      => array(
				'name'       => __( 'Template Editor', 'wp-assistant' ),
				'desc'       => __( 'Template Editor', 'wp-assistant' ),
				'default'    => 1,
				'activation' => 1,
			),
